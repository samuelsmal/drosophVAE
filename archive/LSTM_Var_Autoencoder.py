# comes from https://github.com/Danyleb/Variational-Lstm-Autoencoder/blob/master/LstmVAE/model.py
import tensorflow as tf
import numpy as np
import six
from timeit import default_timer as timer

class LSTM_Var_Autoencoder:
    def __init__(self, intermediate_dim=None, z_dim=None, n_dim=None, stateful=False):
        """
        Args:
